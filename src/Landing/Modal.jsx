...
function Modal() {
    ...
    return (<div className=" w-full  h-[85%]" >
        ...
        <div className=" flex flex-col  gap-10 justify-center px-14   w-[40%] h-[100%]" >
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 18V6l8 6-8 6Z"/>
        ...
        <div className="w-[60%]   grid relative bottom-0 " style={{gridTemplateColumns:"repeat(6,1fr)",gridTemplateRows:"repeat(5,1fr)",height:"100%"}}>
            <div className="border-[30px]  border-b-0 border-e-0 rounded-ss-3xl border-yellow-300 h-[100%] absolute w-full" style={{gridColumnStart:"7",gridColumnEnd:"1 ",gridRowStart:"6",gridRowEnd:" 4 ",alignSelf:"center",bottom:0}}>
            </div>
            <div className="border-[30px] border-b-0 border-e-0 rounded-ss-3xl border-purple-600  h-[100%] absolute w-full" style={{gridColumnStart:"7",gridColumnEnd:"3 ",gridRowStart:"6",gridRowEnd:" 2",alignSelf:"center"}}>
            </div>
            <div className="border-[30px] border-b-0 border-e-0 rounded-ss-3xl border-fuchsia-600  h-[100%] absolute w-full" style={{gridColumnStart:"7",gridColumnEnd:"2",gridRowStart:"6",gridRowEnd:"3",alignSelf:"center"}}>
            </div>
            <div  className="shadow-2xl   shadow-black z-10 h-[70vh] w-fit rounded-3xl" style={{gridColumnStart:"6", gridColumnEnd:"4",gridRowStart:"5",gridRowEnd:"1",alignSelf:"center"}}>
