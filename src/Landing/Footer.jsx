...
<footer class="bg-gray-900">
    <div class="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
          ...
          <div class="flex sm:flex-row flex-col gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="" class="hover:underline">Ltempy</a>
                      </li>
                      <li class="mb-4">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="" class="hover:underline">LTempy</a>. All Rights Reserved.
          </span>
